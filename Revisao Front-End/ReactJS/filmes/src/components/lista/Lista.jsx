                                ...
                                props.lista.map((item) => (
                                    <tr className="item_lista" key={item.idGenero}>
                                        ...
                                        <td data-cell="Imagem" style={{ display: props.visibilidade }}>
                                            ...
                                            <img className="img_cartaz" src={(`https://localhost:7146/imagens/${item.imagem}` == `https://localhost:7146/imagens/` || `https://localhost:7146/imagens/${item.imagem}` == `https://localhost:7146/imagens/null` || `https://localhost:7146/imagens/${item.imagem}` == `https://localhost:7146/imagens/undefined`) ? `https://localhost:7146/imagens/default.jpg` : `https://localhost:7146/imagens/${item.imagem}`} alt="Imagem" />
                                        </td>
                                        <td data-cell="Nome">
